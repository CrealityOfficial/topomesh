...
{		
	...
	void getDisCoverFaces(MMeshT* mesh, std::vector<int>& faces, std::map<int, int>& fmap,std::vector<trimesh::vec3>& mesh_normal, std::vector<trimesh::vec3>& face_center,trimesh::vec3 camera_pos);
